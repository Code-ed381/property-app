...
import { DeleteApartmentAction } from "./DeleteApartmentAction";
      ...
      return (
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-slate-500">Unit {apartment.unit_number} • Level {apartment.floor}</span>
          </div>
        </div>
      );
    },
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-slate-900 border-slate-800 text-slate-300 w-48">
            ...
            <DropdownMenuSeparator className="bg-slate-800" />
            <DeleteApartmentAction id={apartment.id} />
          </DropdownMenuContent>
        </DropdownMenu>
      );
    },
